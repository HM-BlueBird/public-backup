...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'BlueBirdEx@8yf2nl.onmicrosoft.com',
  ...
  title: "TEAM PEAR OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/DRIVE SHARED',
  ...
  email: 'mailto:mharismaulana112@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/HM-BlueBird',
    },
  ],
